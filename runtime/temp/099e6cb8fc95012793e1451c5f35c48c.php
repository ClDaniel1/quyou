<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"E:\wamp64\www\quyou\public/../application/admin\view\hotel\hotelAppend.html";i:1517467517;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="form form-horizontal" id="form-article-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder=""  name="hotelName">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">酒店描述：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" name="hotelDescribe">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">酒店房间：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="number" class="input-text" value="0" placeholder="" name="hotelNum">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">酒店价格：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="number" class="input-text" value="0" placeholder="" name="hotelPrice">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">酒店位置：</label>
            <div class="formControls col-xs-8 col-sm-9">
...
<script type="text/javascript">
                ...
                if ( file.getStatus() === 'invalid' ) {
                    ...
                    uploader.makeThumb( file, function( error, src ) {
                        ...
                        if( isSupportBase64 ) {
                            ...
                            $.ajax('__STATIC__/lib/webuploader/0.1.5/server/preview.php', {
                                method: 'POST',
                                data: src,
                                dataType:'json'
    ...
    var hotelIndex="<?php echo url('admin/Hotel/hotel'); ?>";
</script>
